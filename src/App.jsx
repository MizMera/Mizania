...
function App() {
    ...
    // Initial session fetch + auth listener
    useEffect(() => {
        setAuthLoading(true);
    ...
    // Realtime subscription to keep own profile in sync (role / approved changes)
    useEffect(() => {
        ...
        <>
            ...
            <Router>
                <Routes>
                    ...
                    {/* Protected Routes: All routes under here require a logged-in user */}
                    <Route 
                        path="/"
                        element={
